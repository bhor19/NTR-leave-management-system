...
if(isset($_POST['submit'])){
	...
	if($id>0){
		...
		$sql="insert into tblemployees(`EmpId`,`Name`,`Group`,`Department`,`Gender`,`Password`,`Role`) values('$EmpId','$Name','$Group','$Department','$Gender', '$Password','Employee')";
	}
	//echo $sql;
                        ...
                        <div class="card-body card-block">
                           ...
                           <form method="post">
							   ...
							   <div class="form-group">
									...
									<input type="text" value="<?php echo $EmpId?>" name="EmpId" placeholder="Enter Employee Emp Id" class="form-control" required>
								</div>
								...
								<div class="form-group">
									...
									<input type="text"  name="Password" placeholder="Enter Employee Password" class="form-control" required>
								</div>
